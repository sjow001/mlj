...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog">
      <div class="modal-content">
		 ...
		 <input type="text" class="form-control" id="login" placeholder="请输入账号" value="红贵族黄江店"><br>
		 <input type="text" class="form-control" id="passwd" placeholder="请输入密码" value="201281"><br>
			...
			$(this).button('loading').delay(1000).queue(function() {
				...
				$.ajax({
					...
					success:function(msg){
						if(msg == "1"){
							alert("登陆成功，获取数据中");
							location.href='login.php?action=curlmember&shopname='+$('#login').val();
						}else{
							alert(msg);
							$("#login_btn").button('reset');
						}
